                ...
                <div class="row">
                  <div class="col-md-4">
                    <form wire:submit='updateImage'>
                      <div class="row mb-3">
                        ...
                        <img src="{{Storage::url(Auth::guard('student')->user()->image)}}" alt="Student profile"
                          style="width: 100%; height:300px">

                        @else
                        <img src="{{asset('assets/img/no-image/no-image1.png') }}" alt="Student profile"
                          style="width: 100%; height:300px">
                      ...
                      <div class="row">
                        ...
                        <input wire:model.live='new_image' type="file" name="" id="" class="form-control">
                        @error('new_image')
                  ...
                  <div class="col-md-8">
                    <form wire:submit='updateStudent'>
                      ...
                      <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Middlename:</label>
                        <div class="col-sm-12 col-md-7">
