              ...
              <div class="col-12">
                  <div class="card">
                      ...
                      <div class="card-body">
                       ...
                       @enderror
  @if($image)
      <img class="img-fluid rounded " style="height: 100px; width:100px" src="{{ $image->temporaryUrl() }}" alt="">
  @endif
                          </div>
                        ...
                        <div wire:ignore class="form-group row mb-4">
                          ...
                          <div class="col-sm-12 col-md-7">
                            <textarea id="message" wire:model='content' class="form-control" ></textarea>
                            @error('content')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
