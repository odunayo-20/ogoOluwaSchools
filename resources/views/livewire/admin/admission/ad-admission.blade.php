                  ...
                  <div class="card mb-0">
                    <div class="card-body">
                      <ul class="nav nav-pills">
                        <li class="nav-item">
                          <a class="nav-link active" href="#">All <span class="badge badge-white">{{ count($admissions) }}</span></a>
                        </li>
  ...
  @foreach ($admissions as $value)
      <tr>
          ...
          <td>
              ...
              <a  href="{{ url('admin/admission/view/'.$value->id) }}" class="btn btn-sm btn-warning"><i class="fa fa-eye"></i></a>
