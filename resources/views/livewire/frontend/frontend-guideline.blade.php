    ...
    color: white; height: 50px ;">
                        ...
                        <div class="card-body mb-3">
                            <div class="card-text ">
                                <a href="{{ route('guideline') }}" class="btn btn-light mb-2 disabled"> Admission Guildlines </a>
                                <a href="{{ route('admission') }}" class="btn btn-light mb-2 ">Fill Admission Form </a>
                ...
                <div class="col-md-9 right-cards ">
                    <div class="card mt-3 mb-3">
                      ...
                      color: white;">
                        ...
                        <div class="container">
                            <ul class="mt-3">
                                <li>Obtain form(s) at any of the addresses below. You can Download the Admission Form or fill the Form online and print your Confirmation Page.</li>
                                <li>Bring the completed form(s) to the exam hall at Ogo Oluwa Group of Schools Emure-Ile Campus on the day of the entrance exam. Form(s) can also be obtained on the examination day.</li>
                                <li>Far distant candidates can pay to: Zenith Bank PLC, Ogo Oluwa Group of Schools, and come with the teller for collection of Form on the Examination day. There will be free accommodation for any candidates who want to come prior to the day of Examination.</li>
                                <li>Entrance Examination holds at Ogo Oluwa Group Schools, Emure-Ile Campus EVERY SATURDAY form July 9th to September 10th. There would be few chances for late entries. TIME: 10:00am each day.
                      ...
                      color: white;">
                        ...
                        <div class="container">
                            <strong class="mt-2 text-center">
                                <h5>FORM CAN BE OBTAINED AT ANY OF THE FOLLOWING CENTRES BY PAYMENT OF NON-REFUNDABLE FEE OF N1500.</h5>
                            </strong>
                            <hr>
